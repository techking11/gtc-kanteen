<?php
include './__action/header.php';
if (empty($_SESSION['username'])) {
  echo "
  <div class='alert alert-danger alert-dismissible' style='color:red;'>
    <button type='button' class='close' data-dismiss='alert'>&times;</button>
    <strong>Warning !</strong> Please sign in to your account !
  </div>
  ";
}
?>
...
<!-- food section -->
<section class="food_section pt-3 layout_padding" id="all_shop">
  <div class="container">
