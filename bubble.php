                  ...
                  <div class="col-lg-6 mt-3">
                      <div class="d-flex align-items-center">
                          ...
                          <div class="w-100 d-flex flex-column text-start ps-4">
                              ...
                              <small class="text-justify"><?php echo substr($value['menu_content'], 0, 250); ?><a href="bubble_menu.php?id=<?php echo $value['id']; ?>"> Read More ...</a> </small>
                          </div>
                      </div>
                  </div>
                  <?php
