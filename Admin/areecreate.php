...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="text-info">ARee KanTeen Create Menu</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            ...
            if (isset($_POST['send_data'])) {
              ...
              $sql = "INSERT INTO tblareekanteen (menu_name, menu_img, menu_content, menu_price) VALUES (?, ?, ?, ?)";
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="areecreate.php" class="form" method="post" enctype="multipart/form-data">
