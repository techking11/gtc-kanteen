...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="text-info">Bubble KanTeen Create Menu</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            ...
            if (isset($_POST['send_data'])) {
              ...
              $sql = "INSERT INTO tblbubblekanteen (menu_name,menu_series, menu_img, menu_content, menu_price) VALUES (?, ?, ?, ?,?)";

              if ($stmt = $database->prepare($sql)) {
                $stmt->bindParam(1, $menu_name);
                $stmt->bindParam(2, $menu_series);
                $stmt->bindParam(3, $menu_image);
                $stmt->bindParam(4, $menu_content);
                $stmt->bindParam(5, $menu_price);
              }
              $stmt->execute();
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="bubblecreate.php" class="form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter menu series " name="menu_series"  autocomplete="off">
                </div>
                <div class="form-group">
