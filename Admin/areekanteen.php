...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="text-info">ARee KanTeen</h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header d-flex">
              <a href="areecreate.php" class="btn btn-success">New Menu</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                  ...
                  if ($result) {
                    ...
                    foreach ($result as $value) {
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <a href="areeview.php?id= <?php echo $value['id']; ?>" class="btn btn-secondary">View</a>
                            <a href="areeupdate.php?id= <?php echo $value['id']; ?>" class="btn btn-info">Edit</a>
                            <a href="areedelete.php?id= <?php echo $value['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this item !'); ">Delete</a>
                          </div>
                        </td>
                      </tr>
                      <?php
              ...
              <?php
              $stmt = $database->prepare("SELECT count(*) as Total FROM tblareekanteen");
              $stmt->execute();
              $res = $stmt->fetchAll();
              ?>
